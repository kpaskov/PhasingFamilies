...
#
#
#SBATCH --job-name=pulldp
#SBATCH --output=logs/pulldp_%a.out
#SBATCH --error=logs/pulldp_%a.err
...
echo "My SLURM_ARRAY_TASK_ID is " $SLURM_ARRAY_TASK_ID
    srun python3 preprocessing/pull_dp_data_cat.py ../../../ihart/vcf/v34/$SLURM_ARRAY_TASK_ID.reheader.vcf.gz split_gen_ihart $SLURM_ARRAY_TASK_ID
